                ...
                if (extras != null) {
                    ...
                    if (Value > 0) {
                        if (content.getText().toString().trim().equals("")
                            ...
                            snackbar = Snackbar
                                    .make(coordinatorLayout, "Пожалуйста, введите имя записи", Snackbar.LENGTH_LONG);
                            snackbar.show();
                        } else {
                            if (mydb.updateNotes(id_To_Update, name.getText()
                                    ...
                                    .toString())) {
                                snackbar = Snackbar
                                        .make(coordinatorLayout, "Ваша запись обновлена!", Snackbar.LENGTH_LONG);
                                snackbar.show();
                            } else {
                                snackbar = Snackbar
                                        .make(coordinatorLayout, "Это ошибка, извините пж", Snackbar.LENGTH_LONG);
                                snackbar.show();
                            }
                        }
                    } else {
